...
export function Start() {
    ...
    return (
        <div style={{display: 'flex', justifyContent: 'center', width: '80%', flexWrap: 'wrap', margin: '0px auto', padding: '10px', borderRadius: '5px', marginTop: '15px'}}>
            ...
            <div style={{ width: 'min(400px, 100%)',  borderRadius: '5px', padding: '5px', marginTop: '10px'}}>
                <div style={{borderBottom: '2px solid white', paddingBottom: '10px', marginTop: '10px', display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'center'}}>
            ...
            <div style={{borderBottom: '2px solid white', paddingBottom: '10px',marginTop: '10px',marginBottom: '10px', display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'center'}}>
            ...
            <div style={{width: '100%', textAlign: 'center'}}>
             <h5 style={{color: 'white', margin: '5px auto'}}>*one color will be a decoy and will not reveal any pixels</h5>
            </div>
